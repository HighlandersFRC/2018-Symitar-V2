...
public class CenterChooserAuto extends CommandGroup {
    ...
    public CenterChooserAuto(char dir) {
    	...
    	if(dir=='R'){
    		...
    		addSequential(new Wait(0.1));
    		addSequential(new motionMagicDriveForward(119, RobotMap.navx.getAngle(), 1100, 1500));
    		addSequential(new navxTurn(-38,0.75f));
    		addSequential(new Wait(0.1));
    		addSequential(new motionMagicDriveForward(9, RobotMap.navx.getAngle(), 1100, 1500));
            addSequential(new OutTakeCrate(0.1,0.8));
